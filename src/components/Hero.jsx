      ...
      <div className="relative z-10 flex flex-col items-center mt-24 pt-16 pb-16">
        ...
        >
          ...
          <div style={{ padding: "0 16px 16px 16px" }}>
            <p style={{fontSize:"18px"}} className="text-gray-600 text-m text-justify mb-3 px-5">{current.description}</p>
            <div className="flex justify-around items-center text-sm font-semibold pt-4">
              <div className="text-center">
                <p style={{fontSize:"16px"}} className="text-xs text-gray-500 mb-2">TVL</p>
                <p className="text-xl font-bold text-gray-800">{current.tvl}</p>
              </div>
              <div className="text-center">
                <p style={{fontSize:"16px"}} className="text-xs text-gray-500 mb-2">Net APY</p>
                <p className="text-xl font-bold text-gray-800">{current.apy}</p>
              </div>
              <div className="text-center">
                <p style={{fontSize:"16px"}} className="text-xs text-gray-500 mb-2">Redemptions</p>

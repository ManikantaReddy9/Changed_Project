...
const Navbar = () => {
  return (
    <nav
      ...
      className="fixed top-6 left-1/2 -translate-x-1/2 flex items-center justify-between px-4 py-3 bg-gray-200 shadow-lg z-50"
    >
      ...
      {/* Button */}
      <button className="px-4 py-2 rounded-full bg-green-300 text-black font-semibold shadow-md hover:opacity-90">
        Enter App
      </button>
    </nav>
  );
